...
class DepartementController extends AbstractController
{
    ...
    /**
     * @Route("/prof/{id}/dep", name="professeur_index_dep")
     */
   public function index_dep(Departement $departement): Response
    {
        $prof=$departement->getProfesseurs();

        return $this->render('departement/profbydepartement.html.twig', [
                'professeurs'=>$prof,
            ]);
    }
